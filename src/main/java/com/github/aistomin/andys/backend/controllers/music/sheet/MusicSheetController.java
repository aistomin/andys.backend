...
public final class MusicSheetController {
     ...
     * Edit music sheet.
     *
     * @param sheet Music sheet that needs to be updated.
     * @return Updated music sheet.
     */
    @PutMapping()
    public ResponseEntity<MusicSheetDto> edit(
        @RequestBody final MusicSheetDto sheet
    ) {
        return new ResponseEntity<>(
            this.musicSheets.save(sheet), HttpStatus.OK
        );
    }
